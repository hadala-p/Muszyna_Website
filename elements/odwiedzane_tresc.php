...
while ($wiersz = mysqli_fetch_row($rezultat)) 
 {
  echo "<div class=\"top_view_ramka_tresc col-md-4 \"><a href=\"$wiersz[2].php\"><em>Numer:$i</em><br><p style=\"font-size:10px;\">Odwiedzeń strony:$wiersz[37]</p><img class=\"zdjecie\" src=\"img/$wiersz[4]\" alt=\"$wiersz[3]\">$wiersz[3]</a></div>";
  $i=$i+1;
 }
